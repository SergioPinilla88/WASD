...
const productMiddlewares = [
    ...
    body('fabricante').notEmpty().withMessage("Si desconoce el fabricante coloque 'Desconocido' por favor").bail()
    .isLength({min:2, max: 100}).withMessage('Debes colocar caracteres, 2 minimo y 100 maximo'),
    body('paisOrigen').notEmpty().withMessage("Si desconoce el pais de origen coloque 'Desconocido' por favor").bail()
    .isLength({min:3, max: 50}).withMessage('Debes colocar caracteres, 3 minimo y 50 maximo'),
    ...
    .isLength({min:3, max: 1500}).withMessage('Debes colocar caracteres, 3 minimo y 1500 maximo'),
    body('categoria').notEmpty().withMessage("Describa la categoria del producto por favor").bail()
     .isLength({min:3, max: 1000}).withMessage('Debes colocar caracteres, 3 minimo y 1000 maximo'),
    ...
    .isNumeric().isLength({min:1, max: 10}).withMessage('Debes colocar caracteres, 1 minimo y 10 maximo'),
     body('calificacion').isLength({min:1, max: 500})
     .withMessage('Debes colocar caracteres, 1 minimo y 500 maximo'),
